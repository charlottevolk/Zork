...
class Room {
	...
	public void setExit(char direction, Exit r) throws Exception {
		String dir = "";
		switch (direction) {
		case 'E':
			dir = "east";
	 ...
	 */
	public void setExits(Exit north, Exit east, Exit south, Exit west, Exit up, Exit down) {
		if (north != null)
	 ...
	 */
	public Exit nextExit(String direction) {
		return (Exit) exits.get(direction);
	}
